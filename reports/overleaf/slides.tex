...
\begin{frame}{Prepared context làm thay đổi COMMIT, nhưng chưa cho thấy lợi ích ổn định}
  ...
  \end{alertblock}
  \vspace{-0.2em}
  \centering\scriptsize Held-out TEST: chất lượng giảm so với DEV; không chọn lại ngưỡng từ TEST.
\end{frame}
  ...
  \begin{columns}[T,onlytextwidth]
    ...
    \begin{column}{0.49\textwidth}
      ...
      \begin{itemize}
        ...
        \item \textbf{TEST đã được mở một lần sau freeze; không tuning sau TEST.}
      \end{itemize}
    \end{column}
  \end{columns}
\end{frame}
